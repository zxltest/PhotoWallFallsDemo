...
public class MyScrollView extends ScrollView implements OnTouchListener {
    ...
    class LoadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            mImageUrl = params[0];
            Bitmap imageBitmap = mAsyncImageLoader.getBitmapFromMemoryCache(mImageUrl);
            if (imageBitmap == null) {
        ...
        private Bitmap loadImage(String imageUrl) {
            ...
            Bitmap bitmap = mAsyncImageLoader.decodeSampledBitmapFromResource(imageFile.getPath(), columnWidth);
            mAsyncImageLoader.addBitmapToMemoryCache(imageUrl, bitmap);
            return bitmap;
        }
